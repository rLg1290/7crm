-- Corrigir ambiguidade na função admin_create_user
-- O erro "column reference 'role' is ambiguous" ocorre porque o parâmetro da função tem o mesmo nome da coluna na tabela profiles
-- Solução: Renomear os parâmetros da função ou qualificar explicitamente as colunas
...
BEGIN
  ...
  -- Qualificando profiles.role para evitar ambiguidade
  IF NOT EXISTS (
