...
-- 4. Se não há dados, inserir fornecedores de exemplo
DO $$
DECLARE
...
BEGIN
    ...
    IF fornecedor_count = 0 THEN
        ...
        INSERT INTO fornecedores (nome, cnpj, email, telefone, endereco, observacoes, user_id) VALUES
        ('CVC Viagens', '12.345.678/0001-90', 'contato@cvc.com.br', '(11) 3003-3003', 'Av. Paulista, 1000 - São Paulo/SP', 'Maior operadora de turismo do Brasil', NULL),
        ('Decolar.com', '98.765.432/0001-10', 'atendimento@decolar.com', '(11) 3003-4000', 'Rua Augusta, 500 - São Paulo/SP', 'Plataforma online de viagens', NULL),
        ('123 Milhas', '11.222.333/0001-44', 'suporte@123milhas.com', '(11) 3003-5000', 'Av. Brigadeiro Faria Lima, 2000 - São Paulo/SP', 'Especialista em milhas aéreas', NULL),
        ('Hoteis.com', '55.666.777/0001-88', 'reservas@hoteis.com', '(11) 3003-6000', 'Rua Oscar Freire, 300 - São Paulo/SP', 'Reservas de hotéis', NULL),
        ('Booking.com', '99.888.777/0001-66', 'ajuda@booking.com', '(11) 3003-7000', 'Av. Rebouças, 1500 - São Paulo/SP', 'Reservas de hospedagem', NULL);
